...
public class ViewpagerAdapter extends PagerAdapter {
    ...
    public ViewpagerAdapter(LayoutInflater inflater,ArrayList<String> datas) {
    ...
    public int getCount() {
        ...
        return imgUrlDatas.size(); //이미지 개수 리턴(그림이 10개라서 10을 리턴)
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        view= inflater.inflate(R.layout.viewpage_img, null);
